...
from .forms import UserLoginForm, PwdResetForm ,RwdResetConfirmForm
...
urlpatterns = [
    ...
    path('password_reset_confirm/<uidb64>/<token>',auth_views.PasswordResetConfirmView.as_view(template_name='account/user/password_reset_confirm.html',
                                                                                                ...
                                                                                                form_class=RwdResetConfirmForm),name='password_reset_confirm'),
    ...
    path('wishlist/',views.wishlist,name="wishlist"),
     path('wishlist/add_to_wishlist/<int:id>/',views.add_to__wishlist,name='user_wishlist'),
]
