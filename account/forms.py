...
class RegistrationForm(forms.ModelForm):
    ...
    email = forms.EmailField(max_length=100,help_text='Required',error_messages={'required':'Input email please'})
    ...
    def clean_user_name(self):
        ...
        r = UserBase.object.filter(user_name=username)
        if r.count():
...
class RwdResetConfirmForm(SetPasswordForm):
